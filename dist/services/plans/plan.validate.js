...
exports.validatePlanDraft = validatePlanDraft;
...
function validatePlanDraft(input) {
    ...
    const effectiveMaxSteps = Math.min(input.policy.maxSteps, input.skill.caps.maxSteps ?? Number.MAX_SAFE_INTEGER);
    ...
    const effectiveMaxToolCalls = Math.min(input.policy.maxToolCalls, input.skill.caps.maxToolCalls ?? Number.MAX_SAFE_INTEGER);
    ...
    const effectiveMaxPages = Math.min(input.policy.maxPages, input.skill.caps.maxPages ?? Number.MAX_SAFE_INTEGER);
