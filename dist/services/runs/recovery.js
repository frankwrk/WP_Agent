...
exports.recoverStaleActiveRuns = recoverStaleActiveRuns;
const RUN_EXECUTION_ABORTED = "RUN_EXECUTION_ABORTED";
async function recoverStaleActiveRuns(options) {
    ...
    options.logger.info({ recoveredRuns: staleRuns.length, staleMinutes, cutoffIso }, "run recovery marked stale active runs as failed");
